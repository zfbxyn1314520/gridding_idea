...
public class User implements Serializable {
	...
	public User(Integer userId, Integer areaId, Integer roleId,
			String userName, String password, String headIcon,
			String mobileTel, String officeTel, String editUserName,
			Date editUserDate, Integer user_enable, Role role, Area area) {
		super();
		this.userId = userId;
		this.areaId = areaId;
		this.roleId = roleId;
	...
	public String toString() {
		return "User [userId=" + userId + ", areaId=" + areaId + ", roleId="
				+ roleId + ", userName=" + userName + ", password=" + password
				+ ", headIcon=" + headIcon + ", mobileTel=" + mobileTel
				+ ", officeTel=" + officeTel + ", editUserName=" + editUserName
				+ ", editUserDate=" + editUserDate + ", user_enable="
				+ user_enable + ", user_login_ip=" + user_login_ip
				+ ", user_last_login=" + user_last_login + ", role=" + role
				+ ", area=" + area + "]";
	}
