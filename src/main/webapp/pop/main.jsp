...
<html>
  <head>
	...
	<style type="text/css">
    	...
    	.lnc ul>li>a:hover{width: 90px;border-radius: 5px;margin: 4px;}	
    	.selectpicker{height:auto; min-height: 32px;}
		.row-input{padding-top: 15px;}
		.row-label:first-of-type{padding-left:12px;}
		.row-label:nth-of-type(2){padding-left:50px;}
		.dialogFooterBtn{float:right; margin-right:25px;}
	</style>
				...
				<ul>
					...
					<li class="dropdown active lnc">
						...
						<ul class="dropdown-menu" id="bjui-themes">
                            ...
                            -->
							<li class="active">
								<a href="javascript:;" class="theme_purple" data-toggle="theme" data-theme="purple" style="color: purple;">&nbsp;
									<i class="fa fa-tree"></i> 紫罗兰
								</a>
							</li>
							<li>
								<a href="javascript:;" class="theme_blue" data-toggle="theme" data-theme="blue" style="color: blue;">&nbsp;
									<i class="fa fa-tree"></i> 天空蓝
								</a>
							</li>
							<li>
								<a href="javascript:;" class="theme_green" data-toggle="theme" data-theme="green" style="color: green;">&nbsp;
	...
	<div id="bjui-body-box">
		<div class="container_fluid" id="bjui-body">
			...
			<div id="bjui-sidenav-col">
				<div id="bjui-sidenav" >
					<div id="bjui-sidenav-arrow" data-toggle="tooltip" data-placement="left" data-title="隐藏菜单" style="position:absolute; left:180px;">
						            ...
						            <div class="col-md-6">
						                <div class="panel panel-default">
						                    ...
						                    <div class="panel-body">
						                       <div style="mini-width:400px;height:350px" data-toggle="echarts" data-type="pie,funnel" data-theme="macarons" data-url="pop/echarts-pieData.html"></div>
						                    </div>
						                </div>
						            </div>
						            <div class="col-md-6">
						                <div class="panel panel-default">
						                    <div class="panel-heading"><h3 class="panel-title"><i class="fa fa-bar-chart-o fa-fw"></i>中国地图 </h3></div>
						                    <div class="panel-body">
						                        <div style="mini-width:400px;height:350px" data-toggle="echarts" data-type="map" data-url="pop/echarts-mapData.html"></div>
						                    </div>
						                </div>
						            </div>
						            <div class="col-md-12">
						                <div class="panel panel-default">
						                    <div class="panel-heading"><h3 class="panel-title"><i class="fa fa-bar-chart-o fa-fw"></i>柱状/拆线图 </h3></div>
						                    <div class="panel-body">
						                        <div style="mini-width:400px;height:350px" data-toggle="echarts" data-type="bar,line" data-url="pop/echarts-barData.html"></div>
						                    </div>
						                </div>
						            </div>
						        </div>
		...
		function quitLogin(){
			$.ajax({
				...
				success:function(data){ 
					/* var url=window.location.host+"/grid";
					console.log(url);
					console.log(top.location)
					console.log(window.location.href); */
					window.location.href = "http://www.eollse.cn:8080/grid"; 
				}
			});
		} 
	</script>
