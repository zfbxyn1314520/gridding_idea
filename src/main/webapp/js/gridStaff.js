	...
	BJUI.dialog({
	    ...
	    onLoad:function($dialog){
			...
			$("#gridStaffIcon").click(function(event){
				...
				$.CurrentDialog.find("#filePicker div:last").css({"left":"268.5px","width":"156px","height":"25px","bottom":"auto","right":"auto"});
	...
	$.CurrentDialog.find("#submitBtnbst").click(function() {
		if($.CurrentDialog.find("#editBlockGridStaffInfo").isValid()){
			$.ajax({
				...
				data:{"oldId":e,"newBgId":$.CurrentDialog.find("#block_gridStaffId").val(),"newPgId":$.CurrentDialog.find("#pop_gridStaffId").val()},
				dataType:"text",
				cache : false,
				success:function(data){
					if(data=='删除失败！'){
